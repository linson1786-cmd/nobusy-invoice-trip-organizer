...
# 从 OBSIDIAN_VAULT 反推路径，避免硬编码特定用户路径
_vault_default = os.path.expanduser("~")
_invoice_rel_default = "个人行程与报销/01 发票整理"
BASE_ROOT = os.path.join(_vault_default, _invoice_rel_default)
...
def link_to_trips(success_list):
    ...
    if not trip_root:
        # 从 OBSIDIAN_VAULT + TRIP_BASE_REL 反推
